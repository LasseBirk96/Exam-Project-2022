...
sys.path.append("..")
from DatabaseLayer.Queries.driver_pg_queries import (
    persist_driver,
    driver_login,
    get_driver_by_id,
    get_points_by_id,
...
def test_update_driver_points(postgresql):
    ...
    new_total = update_driver_points(
        driver_id, points_to_be_added, current_points, postgresql
    )
